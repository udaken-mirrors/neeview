...
namespace NeeView
{
    public class FileViewContent : ViewContent, IDisposable
    {
        ...
        public FileViewContent(PageFrameElement element, PageFrameElementScale scale, ViewSource viewSource, PageFrameActivity activity) : base(element, scale, viewSource, activity)
        {
