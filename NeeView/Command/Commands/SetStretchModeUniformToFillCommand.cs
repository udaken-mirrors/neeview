...
namespace NeeView
{
    public class SetStretchModeUniformToFillCommand : CommandElement
    {
        ...
        {
            return this.Text + (MainViewComponent.Current.ViewController.TestStretchMode(PageStretchMode.UniformToFill, (e.Parameter.Cast< StretchModeCommandParameter>()).IsToggle) ? "" : " OFF");
        }
        ...
        {
            MainViewComponent.Current.ViewController.SetStretchMode(PageStretchMode.UniformToFill, (e.Parameter.Cast<StretchModeCommandParameter>()).IsToggle);
        }
    }
}
