...
namespace NeeView.Susie.Client
{
    public class SusiePluginRemoteClient : IDisposable
    {
        ...
        public void Connect()
        {
            ...
            {
                subProcessFileName = Path.GetFullPath(Path.Combine(Environment.AssemblyFolder, @"..\..\..\..\..\NeeView.Susie.Server\bin\x86", Environment.ConfigType, @"net8.0\NeeView.Susie.Server.exe"));
            }
